...
RiseKeeper is the mission alarm that makes sure you are awake, not merely that you heard it.
...
Open **Settings → App Icon** and choose Classic, Aurora, Obsidian, or Hyper. Classic is available to everyone; the three alternate icons are included with RiseKeeper Pro.
